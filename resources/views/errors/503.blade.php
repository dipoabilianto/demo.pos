...
<head>
    ...
    <title>Sedang Dalam Perawatan - {{ config('app.name', 'Oribun Bakery') }}</title>
    <style>
    ...
    <div class="card">
        ...
        <div class="icon-wrap">
            <svg class="tool-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17l-5.94 5.94a2.12 2.12 0 01-3-3l5.94-5.93m0 0L11.42 15.17a2.12 2.12 0 013 0l1.5 1.48a2.12 2.12 0 010 3l-5.94 5.94m5.94-11.35l5.94-5.93a2.12 2.12 0 00-3-3l-5.94 5.94m0 0l-1.5-1.48a2.12 2.12 0 010-3l5.94-5.94" />
            </svg>
        </div>

        <div class="code">503</div>
        <h1>Sedang Dalam Perawatan</h1>
        <p class="message">Sistem sedang dalam perawatan. Silakan kembali beberapa saat lagi.</p>
