...
<head>
    ...
    <title>Server Error - {{ config('app.name', 'Oribun Bakery') }}</title>
    <style>
...
<body>
    ...
    <div class="card">
        ...
        <div class="icon-wrap">
            <svg class="warning-icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <p class="message">Maaf, terjadi kesalahan pada server. Silakan coba beberapa saat lagi.</p>
