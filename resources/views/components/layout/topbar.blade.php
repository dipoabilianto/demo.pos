...
<header class="sticky top-0 z-40 backdrop-blur-md border-b border-warm-200/50" style="background-color:color-mix(in srgb,var(--bg-base) 80%,transparent)">
    <div class="flex items-center justify-between px-8 h-16">
        ...
        <div class="flex items-center gap-3">
            ...
            @if($topbarBranch)
            <a href="{{ route('orders.public-catalog', $topbarBranch) }}" target="_blank" rel="noopener noreferrer" class="hidden md:flex items-center gap-2 rounded-lg bg-theme-primary/10 px-4 py-2 text-sm font-medium text-theme-primary hover:bg-theme-primary/20 transition-colors ring-1 ring-theme-primary/20">
