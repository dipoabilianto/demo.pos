...
<head>
    ...
    <title>Lupa Password - {{ $storeSettings['store_name'] ?? 'Oribun Bakery' }}</title>
        ...
        <div class="flex w-full items-center justify-center px-6 py-12 lg:w-[35%]">
            <div class="w-full max-w-sm">
                ...
                <div class="rounded-2xl bg-white p-8 ring-1 ring-stone-100 shadow-xl shadow-stone-200/50">
                    ...
                    <p class="text-sm text-stone-500 mb-6">Masukkan email Anda untuk mendapatkan link reset password</p>
